...
<?php
    ...
    if (isset($_POST['enviar']))
    {
        ...
        $result = $soapclient->comprobar($us_email);
        ...
        if ($result == "NO")
        {
            $error_email .= "El correo introducido no está matriculado en la asignatura Sistemas Web. ";
        }
        ...
        if ($error_email == "" && $error_nom == "" && $error_pw == "" && $result == "SI")
        {
            $link = mysqli_connect($server, $user, $pass, $basededatos);
